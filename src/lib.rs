...
#[derive(Debug)]
pub struct MockBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MockBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MockBridge processing");
    
    let mut processor = MockBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MockBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MockBridgeProcessor::new(false);
